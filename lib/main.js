...
var permissionMap = {
  ...
  calendar: ['alarms', 'systemXHR', 'tcp-socket'],
  camera: ['camera'],
...
var prefs = Cc['@mozilla.org/preferences-service;1']
.getService(Ci.nsIPrefBranch);
prefs.setBoolPref('dom.mozAlarms.enabled', true);
...
var messageManager = Cc["@mozilla.org/parentprocessmessagemanager;1"]
  .getService(Ci.nsIMessageListenerManager);

messageManager.addMessageListener('app-notification-send', function(e) {
  console.log('GOT APP NOTIFICATION SEND')
  console.log(e)
});
